...
Rails.application.configure do
  ...
  # Denne linie gør at billeder angivet i stien nedenfor fra fancybox precompiles og vises i development.
  # Jeg har udelukket filen fra upload til server i .gitignore
  ...
  config.action_mailer.smtp_settings = { 
    address:         'mail.kruby.dk',
    port:            8987,
    domain:          'www.kruby.dk',
    authentication:  :login,
    user_name:       'ts%kruby.dk',
    password:        'Atecop40196881',
